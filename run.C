...
int main(int argc, char **argv){
    ...
    IsotrackHitAnalysis a(filename, output_filename, useTowerInfo, useTruthInfo, useCentrality, useParticleGun, centrality, d0, z0, pT, matchedPt, matchedDr, matchedNeutralTruthPt, matchedNeutralTruthEta, matchedNeutralTruthDr, cemcMatchingDr, ihcalMatchingDr, ohcalMatchingDr, cemcMipEnergy, ihcalMipEnergy);
